<?php $__env->startSection('title', 'Receiving History | SAGA POS'); ?>
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-6" x-data="receivingHistory()">
    ...
    <div class="max-w-8xl mx-auto mb-8">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('inventory.receiving.create')); ?>" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-cyan-700 transition-all shadow-lg flex items-center gap-2">
    ...
    <div class="max-w-8xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div x-show="filteredReceivings.length === 0" class="p-12 text-center">
            ...
            <a href="<?php echo e(route('inventory.receiving.create')); ?>" class="inline-flex items-center gap-2 mt-4 px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition font-medium">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project App\laravelsaga\resources\views/pages/inventory/receiving/history.blade.php ENDPATH**/ ?>