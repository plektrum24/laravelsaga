...
<aside
  ...
  <div class="flex items-center justify-center h-16 border-b border-gray-100 dark:border-gray-800">
    <a :href="isSuperAdmin() ? '<?php echo e(route('admin.dashboard')); ?>' : '<?php echo e(route('dashboard')); ?>'"
      ...
      <template x-if="isSuperAdmin()">
        <div class="space-y-4">
          ...
          <ul class="space-y-1">
            ...
            <li>
              <a href="<?php echo e(route('admin.users.index')); ?>" class="sidebar-menu-item"
            ...
            <li>
              <a href="<?php echo e(route('admin.reports.index')); ?>" class="sidebar-menu-item"
            ...
            <li>
              <a href="<?php echo e(route('admin.license.index')); ?>" class="sidebar-menu-item"
  ...
  <div class="border-t border-gray-100 dark:border-gray-800 p-3">
    <a href="<?php echo e(route('profile')); ?>" class="sidebar-menu-item" :class="page === 'profile' ? 'sidebar-menu-active' : ''">
    ...
    <button
      @click="localStorage.removeItem('saga_token'); localStorage.removeItem('saga_user'); localStorage.removeItem('saga_tenant'); localStorage.removeItem('saga_selected_branch'); window.location.href = '<?php echo e(route('dashboard')); ?>'"
...
<!-- ===== Sidebar End ===== --><?php /**PATH D:\Project Aplikasi\laravelsaga\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>