...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SAGA POS - Inventory & Sales Management'); ?></title>
            ...
            return {
                ...
                async searchProduct(query) {
                    ...
                    try {
                        ...
                        const token = localStorage.getItem('saga_token') || '<?php echo e(csrf_token()); ?>'; // Fallback or use Cookie
...
<body class="h-full bg-gray-50 dark:bg-black" x-data="{ 
      page: '<?php echo e(Route::currentRouteName()); ?>', 
      loaded: true, 
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.alert.alert','data' => ['type' => 'success','title' => 'Success!','class' => 'mb-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'success','title' => 'Success!','class' => 'mb-6']); ?>
...
<?php endif; ?>
                    ...
                    <?php if(session('error')): ?>
                        <?php if (isset($component)) { $__componentOriginal6ff20a3d3ab12f313ed285f7a8ce0b1b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ff20a3d3ab12f313ed285f7a8ce0b1b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.alert.alert','data' => ['type' => 'error','title' => 'Error!','class' => 'mb-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('alert.alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'error','title' => 'Error!','class' => 'mb-6']); ?>
...
</html><?php /**PATH D:\Project Aplikasi\laravelsaga\resources\views/layouts/app.blade.php ENDPATH**/ ?>