<?php $__env->startSection('title', 'Dashboard | SAGA TOKO APP'); ?>
    ...
    <div x-data="{
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4 mb-6">
            ...
            <div x-show="user?.role !== 'cashier'"
                ...
                <a href="<?php echo e(route('inventory.index')); ?>?low_stock=true"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6" x-show="user?.role !== 'cashier'">
            <!-- Supplier Debt Alert -->
            <a href="<?php echo e(route('finance.debts')); ?>"
            ...
            <a href="<?php echo e(route('finance.receivables')); ?>"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <a href="<?php echo e(route('inventory.index')); ?>" x-show="!checkRole(['Kasir'])"
            ...
            <!-- Quick Reports -->
            <a href="<?php echo e(route('reports.index')); ?>" x-show="!checkRole(['Gudang'])"
                class="group rounded-2xl border border-gray-200 bg-white p-6 hover:border-brand-300 hover:shadow-lg transition-all dark:border-gray-800 dark:bg-white/[0.03] dark:hover:border-brand-800">
                <div class="flex items-center gap-4">
        ...
        <div x-show="checkRole(['Owner', 'Gudang']) && stats.deadstock && stats.deadstock.length > 0"
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('inventory.deadstock')); ?>" class="text-xs text-brand-600 hover:underline">View All →</a>
            </div>
                ...
                <template x-for="p in stats.deadstock" :key="p.id">
                    <div class="p-4 bg-red-50 dark:bg-red-900/10 rounded-xl border border-red-100 dark:border-red-900/30">
                        ...
                        <div class="mt-2 flex justify-between items-center">
                            ...
                            <a :href="'<?php echo e(url('/inventory/receiving/goods-in')); ?>?restock=' + p.id" class="text-[10px] bg-red-600 text-white px-2 py-1 rounded hover:bg-red-700">Restock</a>
                        </div>
                    </div>
                </template>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project App\laravelsaga\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>