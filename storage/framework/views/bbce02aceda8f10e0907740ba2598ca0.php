...
<aside
  ...
  <div class="flex items-center justify-center h-16 border-b border-gray-100 dark:border-gray-800">
    <a :href="isSuperAdmin() ? '<?php echo e(route('admin.dashboard')); ?>' : '<?php echo e(route('dashboard')); ?>'" class="flex items-center gap-2">
      <!-- Default S Logo -->
    ...
    <nav class="space-y-6">
      ...
      <template x-if="isSuperAdmin()">
        <div class="space-y-4">
          ...
          <ul class="space-y-1">
            ...
            <li>
              <a href="<?php echo e(route('admin.tenants.index')); ?>" class="sidebar-menu-item">
                <svg class="sidebar-menu-icon" viewBox="0 0 24 24" fill="currentColor">
      ...
      <template x-if="!isSuperAdmin()">
        <div class="space-y-1">
          ...
          <!-- Dashboard -->
          <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-menu-item">
            <svg class="sidebar-menu-icon" viewBox="0 0 24 24" fill="currentColor">
              <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/>
            </svg>
            <span x-show="$store.sidebar.open || hovered" class="sidebar-menu-text">Dashboard</span>
          ...
          <div>
            ...
            <ul x-show="openMenu === 'pos' && ($store.sidebar.open || hovered)" class="sidebar-submenu">
              <li><a href="<?php echo e(route('pos.index')); ?>" class="sidebar-submenu-item">Kasir (APP)</a></li>
              <li><a href="<?php echo e(route('pos.history')); ?>" class="sidebar-submenu-item">Riwayat Transaksi</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul x-show="openMenu === 'receiving' && ($store.sidebar.open || hovered)" class="sidebar-submenu">
              <li><a href="<?php echo e(route('inventory.receiving.index')); ?>" class="sidebar-submenu-item">Goods In</a></li>
              <li><a href="<?php echo e(route('inventory.receiving.history')); ?>" class="sidebar-submenu-item">Receiving History</a></li>
              <li><a href="<?php echo e(route('inventory.receiving.supplier-returns')); ?>" class="sidebar-submenu-item">Supplier Returns</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul x-show="openMenu === 'inventory' && ($store.sidebar.open || hovered)" class="sidebar-submenu">
              <li><a href="<?php echo e(route('inventory.index')); ?>" class="sidebar-submenu-item">Current Stock</a></li>
              <li><a href="<?php echo e(route('inventory.stock-management')); ?>" class="sidebar-submenu-item">Stock Management</a></li>
              <li><a href="<?php echo e(route('inventory.stock-transfer')); ?>" class="sidebar-submenu-item">Stock Transfer</a></li>
              <li><a href="<?php echo e(route('inventory.movements')); ?>" class="sidebar-submenu-item">Stock Movements</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul x-show="openMenu === 'partners' && ($store.sidebar.open || hovered)" class="sidebar-submenu">
              <li><a href="<?php echo e(route('inventory.suppliers')); ?>" class="sidebar-submenu-item">Suppliers</a></li>
              <li><a href="<?php echo e(route('customers.index')); ?>" class="sidebar-submenu-item">Customers</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul x-show="openMenu === 'finance' && ($store.sidebar.open || hovered)" class="sidebar-submenu">
              <li><a href="<?php echo e(route('finance.debts')); ?>" class="sidebar-submenu-item">Supplier Debts</a></li>
              <li><a href="<?php echo e(route('finance.receivables')); ?>" class="sidebar-submenu-item">Customer Receivables</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul x-show="openMenu === 'settings' && ($store.sidebar.open || hovered)" class="sidebar-submenu">
              <li><a href="<?php echo e(route('settings.index')); ?>" class="sidebar-submenu-item">Store Settings</a></li>
              <li><a href="<?php echo e(route('settings.loyalty')); ?>" class="sidebar-submenu-item">Loyalty Program</a></li>
            </ul>
          </div>
  ...
  <div class="border-t border-gray-100 dark:border-gray-800 p-3">
    <a href="<?php echo e(route('profile')); ?>" class="sidebar-menu-item">
...
<!-- ===== Sidebar End ===== -->
<?php /**PATH D:\Project App\laravelsaga\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>