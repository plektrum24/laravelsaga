...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('products', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('branch_id')->nullable()->index(); // Ref to Landlord DB
            $table->foreignId('category_id')->nullable()->constrained()->onDelete('set null'); // Ref to Tenant DB (categories)
        ...
        Schema::create('inventory_movements', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('user_id')->nullable()->index(); // Who did it (Ref Landlord DB)
