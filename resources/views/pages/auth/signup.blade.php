...
<head>
    ...
    <title>Sign Up | SAGA TOKO APP</title>
        ...
        <div class="flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <img src="{{ asset('assets/images/common-grid-shape.svg') }}" class="absolute inset-0 z-0">
                    <!-- ===== Common Grid Shape End ===== -->
                    <div class="flex flex-col items-center max-w-xs z-10 relative">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Saga POS & Inventory Management System
                        </p>
                    </div>
                </div>
            </div>
